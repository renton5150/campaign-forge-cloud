-- Fix multi-tenant architecture: Remove constraint and assign default tenant
DO $$
DECLARE
  v_tenant_id uuid;
BEGIN
  ...
  RAISE NOTICE 'Multi-tenant architecture fixed: Default tenant created and all orphaned records assigned';
END $$;